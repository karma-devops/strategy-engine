...
def convert_pine_to_python(pine_source: str, strategy_name: str = "", user_id: str | None = None) -> str:
    ...
    system = (
        ...
        "that returns {'direction': 'BUY'|'SELL'|'NEUTRAL', 'signal': float, 'metadata': dict}. "
        ...
        "The metadata dict must include: adx, fast_ema, medm_ema, slow_sma, "
        "fan_up_trend, fan_dn_trend, stop_loss_long, stop_loss_short, "
        "take_profit_long, take_profit_short, engine_mode, is_strategy_cold, in_warmup."
    )
